...
class Admin_model extends CI_Model {
    ...
    public function get_sister_cities($search = NULL, $order = NULL, $limit = NULL) {
        $data = array();

        $sql = 'SELECT city_id, city.city_name, city.reg_date, last_updated_by, city.active, '
                . 'IF (city.active = 1, "active", "inactive") as active_desc, city.update_date, '
                . 'user.username as last_updated_by, created.username as created_by FROM sister_cities city '
    ...
    public function get_news($search = NULL, $order = NULL, $limit = NULL) {
        $data = array();

        $sql = 'SELECT news_id, news_title, news_body, news_date, news_summary, news.reg_date, news.update_date, '
                . 'user.username as last_updated_by, created.username as created_by FROM news '
    ...
    public function save_news($param_array= array()){
              if(count($param_array) > 0) {
